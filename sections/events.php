<div class="sec" id="events">Récents évènements</div>
  ...
  <div class="event-session" style="opacity:0.7">
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Les premiers résultats des municipales tombent : <strong class="c-gold">Régis Mouflard</strong> est en tête avec 50 % des voix contre 49 % pour <strong class="c-gold">Monsieur Valmont</strong>. Malgré tous les moyens engagés, la campagne de propagande ne semble pas encore avoir produit ses effets.
      </div>
    </div>
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Ulysse Leblanc contacte Jeremy en prétendant vouloir discuter. Accompagné d'Alix, Jeremy se rend au rendez-vous — et découvre qu'il s'agit d'un piège. Ulysse cherche à se venger de l'affaire du Céleste. Jeremy est emmené de force dans un lieu isolé, <strong class="c-red">humilié et photographié dans une mise en scène dégradante.</strong> Une vengeance que Jeremy risque de ne pas oublier.
      </div>
    </div>
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Jeremy retrouve <strong class="c-gold">Monsieur Valmont</strong> pour récupérer le reste de l'argent du tournage politique. Il touche finalement les <strong class="c-green">10 000 €</strong> convenus. Au cours de la discussion, Valmont glisse qu'<strong class="c-red">une taupe pourrait se trouver au sein de la police parisienne.</strong>
      </div>
    </div>
  ...
  <div class="event-session" style="opacity:0.7">
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Jeremy contacte directement <strong class="c-gold">Rita</strong> pour qu'elle intervienne au commissariat, sans respecter les procédures. <strong class="c-red">Rita est temporairement suspendue et tient Jeremy pour responsable.</strong> Une relation jusqu'alors très positive se fragilise.
      </div>
    </div>
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Jeremy assiste à l'interrogatoire du professeur <strong class="c-gold">Juste Mortecouille</strong>, soupçonné d'être impliqué dans la mort de <strong class="c-gold">Léo Montclair</strong>, dont le corps a été retrouvé dans une benne à ordures. Le professeur affirme avoir été absent de Paris une semaine, et reconnaît être l'une des dernières personnes à avoir vu Léo vivant — lors d'une soirée dans les égouts de Paris.
      </div>
      <div class="event-body">
        Faute de preuve décisive, Mortecouille est relâché avec <strong class="c-red">interdiction de quitter la ville.</strong>
      </div>
    </div>
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Jeremy reçoit un appel inattendu de <strong class="c-gold">Fifi</strong>, liée à l'affaire du plat piégé au Céleste. Elle lui propose de se retrouver pour discuter. <strong class="c-red">Ses intentions restent floues.</strong>
      </div>
    </div>
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        La soirée se termine devant le Paradise, où Jeremy retrouve plusieurs membres de sa famille ainsi qu'Alix. Rare moment de calme après une journée chargée en interrogatoires, poursuites et tensions.
      </div>
    </div>
  ...
  <div class="event-session" style="opacity:0.7">
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Jeremy participe au tournage de campagne organisé par <strong class="c-red">Olivier Vautrin</strong>. La mise en scène de la fausse agression tourne au désastre : Jeremy et Louis de Villiers reçoivent de véritables coups. Les deux hommes doivent se rendre à l'hôpital, où Jeremy est soigné par <strong class="c-gold">Rita</strong>, devenue sa médecin habituelle.
      </div>
      <div class="event-body">
        Jeremy n'a touché qu'un acompte de <strong class="c-gold">2 000 €</strong> sur les 10 000 € promis. Vautrin semble désormais vouloir nier l'existence du tournage pour ne pas payer. <strong class="c-red">Louis de Villiers — qui méprisait initialement Jeremy — lui propose de se retourner ensemble contre le député en justice</strong>, en mobilisant des témoins dont potentiellement l'un des faux agresseurs.
      </div>
    </div>
    ...
    <div class="event-card">
      ...
      <div class="event-body">
        Jeremy et Clothilde participent à une séance de kung-fu dirigée par le maître <strong class="c-gold">Wu Yang</strong> au Palais de Jade. L'entraînement devient rapidement un prétexte à leur rivalité habituelle. Au moment de régler les 500 € dus chacun, Jeremy prend la fuite pour laisser Clothilde payer seule, elle refuse évidemment de payer la part de Jeremy.
      </div>
      <div class="event-body">
        <strong class="c-red">⚠ Les responsables du Palais de Jade envisagent de porter plainte pour escroquerie et non-paiement contre les deux.</strong>
      </div>
    </div>
  ...
  <div class="event-session" style="opacity:0.7">
    ...
    <div class="event-card">
      <div class="event-header">
        <span class="event-theme et-danger">Overdose & hôpital</span>
      </div>
      <div class="event-body">
        Jeremy se réveille encore sous l'effet de la cocaïne prise la veille. Les effets ne passant pas, il se rend à l'hôpital pour se faire soigner.
      </div>
    </div>

    <div class="event-card">
      <div class="event-header">
        <span class="event-theme et-relation">Rendez-vous au Céleste · Mme de Montfaucon</span>
      </div>
      <div class="event-body">
        Après ses soins, Jeremy se rend au Céleste pour un rendez-vous avec <strong class="c-gold">Madame de Montfaucon</strong>. Clothilde et Ragnar, attablés à côté, font volontairement du bruit pour lui nuire. Mme de Montfaucon, très occupée, écourte la rencontre — mais propose de la remettre à plus tard.
      </div>
    </div>

    <div class="event-card">
      <div class="event-header">
        <span class="event-theme et-danger">L'affaire Ulysse Leblanc</span>
      </div>
      <div class="event-body">
        Ulysse Leblanc arrive au Céleste. Jeremy, Clothilde et Adrien décident de se venger : Jeremy éjacule discrètement dans son plat. M. Leblanc se régale avant d'apprendre le pot-aux-roses de la bouche de Jeremy lui-même, qui prend la fuite avec Clothilde. <strong class="c-red">⚠ Réaction d'Armand et représailles d'Ulysse : inconnues.</strong>
      </div>
    </div>
  ...
  <div class="event-session" style="opacity:0.5">
    ...
    <div class="event-card">
      <div class="event-header">
        <span class="event-theme et-relation">Relation · Alix</span>
      </div>
      <div class="event-body">
        Malgré les tensions, Alix reste prête à défendre Jeremy en cas de danger. Relation de plus en plus ambiguë, oscillant entre manipulation, rancœur et loyauté instinctive.
      </div>
    </div>
